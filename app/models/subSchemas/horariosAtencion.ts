...
export const horariosAtencionSchema = new Schema({
    mañana: { type: String, default:'cerrado', validate: { validator: validHs, message: 'Horario de mañana mal ingresado' } },
    tarde: { type: String, default:'cerrado', validate: { validator: validHs, message: 'Horario de tarde mal ingresado' } },
    noche: { type: String, default:'cerrado', required: false, validate: { validator: validHs, message: 'Horario de noche mal ingresado' } }
});
